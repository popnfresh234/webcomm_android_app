...
#ifndef AUTHSDKFRAMEWORK_SWIFT_H
#define AUTHSDKFRAMEWORK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AuthSDKFramework",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC16AuthSDKFramework17FittableFontLabel")
...
- (void)setUIEdgeInsetsWithTop:(CGFloat)top left:(CGFloat)left bottom:(CGFloat)bottom right:(CGFloat)right;
- (void)adjustFontSizeAfterContentSizeCategoryDidChange;
